...
// +kubebuilder:webhook:path=/mutate-batch-lumexralph-dev-v1-cronjob,mutating=true,failurePolicy=fail,sideEffects=None,groups=batch.lumexralph.dev,resources=cronjobs,verbs=create;update,versions=v1,name=mcronjob-v1.kb.io,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-batch-lumexralph-dev-v1-cronjob,mutating=false,failurePolicy=fail,sideEffects=None,groups=batch.lumexralph.dev,resources=cronjobs,verbs=create;update,versions=v1,name=vcronjob-v1.kb.io,admissionReviewVersions=v1
...
func validateCronJob(cronjob *batchv1.CronJob) error {
	...
	return apierrors.NewInvalid(
		schema.GroupKind{Group: "batch.lumexralph.dev", Kind: "CronJob"},
